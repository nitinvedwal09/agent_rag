...
kriz@cs.utoronto.ca Ilya Sutskever University of Toronto ilya@cs.utoronto.ca
...
hinton@cs.utoronto.ca Despite the attractive qualities of CNNs, and despite the relative efficiency of their local architecture, they have still been prohibitively expensive to apply in large scale to high-resolution images. Luckily, current GPUs, paired with a highly-optimized implementation of 2D convolution, are powerful enough to facilitate the training of interestingly-large CNNs, and recent datasets such as ImageNet contain enough labeled examples to train such models without severe overfitting.
...
where i is the iteration index, v is the momentum variable, ϵ is the learning rate, and 〈 ∂L ∂w ∣ ∣ w i 〉 D i is the average over the i th batch D i of the derivative of the objective with respect to w , evaluated at w i .
...
| Model  Top-1  Top-5  Sparse coding [2]  47.1%  28.2%  SIFT + FVs [24]  45.7%  25.7%  CNN  37.5%  17.0%   |
|----------------------------------------------------------------------------------------------------------|
